...
public class ContactsApp extends Application {
  ...
  // The JavaFX ObservableListWrapper used to connect to the underlying AddressBookPlain
  ...
  public void init() throws Exception {
    ...
    this.addressBookDBHandler = AddressBookDBHandler.getInstance();//this.mainController.loadAddressBookFromFile();
  }
  ...
  @Override
  public void stop() {
    addressBookDBHandler.close();
    // Save the address book to file
    //this.mainController.saveAddressBookToFile(this.addressBookDBHandler);
  ...
  private MenuBar createMenus() {
    ...
    importFromCsv.setOnAction(event -> mainController.importFromCsv(this.addressBookDBHandler, this));
    menuFile.getItems().add(importFromCsv);

    MenuItem exportToCsv = new MenuItem("Export to .CSV...");
    exportToCsv.setOnAction(event -> mainController.exportToCsv(this.addressBookDBHandler));
