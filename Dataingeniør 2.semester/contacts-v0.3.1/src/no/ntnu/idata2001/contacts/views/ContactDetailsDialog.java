...
public class ContactDetailsDialog extends Dialog<ContactDetails> {
  private AddressBookDBHandler addressBookDBHandler = AddressBookDBHandler.getInstance();
  /**
    ...
    setResultConverter(
        ...
        if (button == ButtonType.OK) {
          ...
          if (mode == Mode.NEW) {
            ...
            addressBookDBHandler.removeContact(existingContact.getPhone());
            ...
            addressBookDBHandler.addContact(result);
          }
        }
        return result;
      }
