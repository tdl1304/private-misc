...
class TestBonusMember {
    public static void main(String[] args) throws Exception {
        ...
        BasicMember b2 = new BasicMember(110, LocalDate.of(2007, 3, 5), tove, 0);
        b2.registerPoints(30000);
        if (b2.findQualificationPoints(testdato) == 30000 && b2.getPoints() == 30000) {
            System.out.println("Test 3 ok");
        }
        SilverMember b3 = new SilverMember(b2.getMemberNo(),b2.getEnrolledDate() ,
                b2.getPersonals(), b2.getPoints());
        b3.registerPoints(50000);
        if (b3.findQualificationPoints(testdato) == 90000 && b3.getPoints() == 90000) {
            System.out.println("Test 4 ok");
        }
        GoldMember b4 = new GoldMember(b3.getMemberNo(), b3.getEnrolledDate(),
                b3.getPersonals(), b3.getPoints());
        ...
        //Siden findQualificationPoints er autofilled med dagens dato i checkMembers metoden, blir poeng satt til 0.
        //Lager dermed nye test-objekter
        memberArchive.addToList(new SilverMember(1,LocalDate.now(),ole, 75000));
        memberArchive.newMember(tove);
        System.out.println(memberArchive.getMemberList());
        System.out.println(memberArchive.checkMembers() + " medlem(mer) ble oppgradert");
        System.out.println(memberArchive.getMemberList().get(0).getEnrolledDate());
